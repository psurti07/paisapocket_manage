...
<script>
    ...
    function deleteRemark(remarks_id){
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: 'https://manage.paisapocket.com/selfapply/applications-details/delete-remarks',
                    type: 'POST',
    ...
    function updProcessStep(userId, appId){
        swal({
            ...
            if (willDelete) {
                $.ajax({
                    url: 'https://manage.paisapocket.com/selfapply/applications-details/update-process',
                    type: 'POST',
