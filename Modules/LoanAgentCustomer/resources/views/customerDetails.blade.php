                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->aadharcard)
                                                                ...
                                                                @foreach($aadhaarArray as $aadhaar)
                                                                    <a class="pdf" href="https://paisapocket.com/{{ $aadhaar }}" target="_blank"><i class="icofont icofont-file-image" style="font-size:30px"></i></a>
                                                                @endforeach
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->pancard)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->pancard }}" target="_blank">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->lightbill)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->lightbill }}" target="_blank">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->cancelcheque)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->cancelcheque }}" target="_blank">
                                                                    <i class="icofont icofont-file-pdf" style="font-size:30px"></i>
                                                                </a>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->bankstatement)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->bankstatement }}" target="_blank">
                                                                    <i class="icofont icofont-file-pdf" style="font-size:30px"></i>
                                                                </a>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->formsixteen)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->formsixteen }}" target="_blank">
                                                                    <i class="icofont icofont-file-pdf" style="font-size:30px"></i>
                                                                </a>
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($kycDoc->salaryslip)
                                                                <a class="pdf" href="https://paisapocket.com/{{ $kycDoc->salaryslip }}" target="_blank">
                                                                    <i class="icofont icofont-file-pdf" style="font-size:30px"></i>
                                                                </a>
                                                            @endif
                                                        </td>
